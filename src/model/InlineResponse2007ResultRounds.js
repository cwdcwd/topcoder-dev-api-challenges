...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2007ResultUserMMDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2007ResultUserMMDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.ApChallengeMicroservice) {
      root.ApChallengeMicroservice = {};
    }
    root.ApChallengeMicroservice.InlineResponse2007ResultRounds = factory(root.ApChallengeMicroservice.ApiClient, root.ApChallengeMicroservice.InlineResponse2007ResultUserMMDetails);
  }
}(this, function(ApiClient, InlineResponse2007ResultUserMMDetails) {
  'use strict';
  ...
  /**
   * The InlineResponse2007ResultRounds model module.
   * @module model/InlineResponse2007ResultRounds
   * @version 1.0.5
   */

  /**
   * Constructs a new <code>InlineResponse2007ResultRounds</code>.
   * @alias module:model/InlineResponse2007ResultRounds
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2007ResultRounds</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2007ResultRounds} obj Optional instance to populate.
   * @return {module:model/InlineResponse2007ResultRounds} The populated <code>InlineResponse2007ResultRounds</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('userMMDetails')) {
        obj['userMMDetails'] = InlineResponse2007ResultUserMMDetails.constructFromObject(data['userMMDetails']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2007ResultUserMMDetails} userMMDetails
   */
