...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ApChallengeMicroservice.InlineResponse2007ResultUserDetails = factory(root.ApChallengeMicroservice.ApiClient, root.ApChallengeMicroservice.InlineResponse200ResultSubmissions);
  }
  ...
  /**
   * The InlineResponse2007ResultUserDetails model module.
   * @module model/InlineResponse2007ResultUserDetails
   * @version 1.0.5
   */

  /**
   * Constructs a new <code>InlineResponse2007ResultUserDetails</code>.
   * @alias module:model/InlineResponse2007ResultUserDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2007ResultUserDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2007ResultUserDetails} obj Optional instance to populate.
   * @return {module:model/InlineResponse2007ResultUserDetails} The populated <code>InlineResponse2007ResultUserDetails</code> instance.
   */
