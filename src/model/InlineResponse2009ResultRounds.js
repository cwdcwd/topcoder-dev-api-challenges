...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2009ResultUserMMDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2009ResultUserMMDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.ApChallengeMicroservice) {
      root.ApChallengeMicroservice = {};
    }
    root.ApChallengeMicroservice.InlineResponse2009ResultRounds = factory(root.ApChallengeMicroservice.ApiClient, root.ApChallengeMicroservice.InlineResponse2009ResultUserMMDetails);
  }
}(this, function(ApiClient, InlineResponse2009ResultUserMMDetails) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('userMMDetails')) {
        obj['userMMDetails'] = InlineResponse2009ResultUserMMDetails.constructFromObject(data['userMMDetails']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2009ResultUserMMDetails} userMMDetails
   */
